...
public class User implements Serializable{
    ...
    public User(int userId, String userName, String userEmail, String userPassword, String userPhone, String userPic, 
            ...
            List<Orders> orders, List<Approve> a, String department) {
        this.userId = userId;
    ...
    public User(String userName, String userEmail, String userPassword, String userPhone, String userPic, String userAddress, String userType, Company companies, String locations, List<UserLocation> test, List<Orders> orders, List<Approve> a) {
        this.userName = userName;
        this.userEmail = userEmail;
        this.userPassword = userPassword;
        this.userPhone = userPhone;
