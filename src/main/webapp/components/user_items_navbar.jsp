...
String sqls ="select COUNT(*) from Approve where stat = 'Not Approved' and locations = '"+company.getCompanyName()+"' ";
...
String Countrow = rs.getString(1);
      ...
      %>
      <li class="nav-item active">
          <a class="nav-link" href="l_pending_orders.jsp">Cart <span>(<%=Countrow%>)</span></a>
      </li>
