...
String vendor3 = request.getParameter("vendor3");
...
String sql ="select * from Item where vTitle = '"+vendor1+"' or vTitle = '"+vendor2+"' or vTitle = '"+vendor3+"' and itemNumber = '"+itemNumber1+"' or itemNumber = '"+itemNumber2+"' or itemNumber = '"+itemNumber3+"'";
