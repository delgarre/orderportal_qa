...
if(items == null){
    response.sendRedirect("a_locations_item_report.jsp");
...
String sql ="select * from OrderHistory where date between '"+date1+"' and '"+date2+"' and FIND_IN_SET(itemNumber,'"+itemsList+"' )";
