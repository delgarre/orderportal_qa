...
function add() {
  ...
  var new_input = "<input type='text' id='new' name='new'>";
                ...
                <div class="col-md-6 offset-md-3">
                 ...
                 <br>
                    ...
                    <div class="card-body">
                        ...
                        <br>
                           <a href="j_locations_desc_report.jsp">
                                    <button class="btn btn-secondary">ADD DESCRIPTION</button>
                           </a><br>
                                <br>
                                 <a href="j_locations_item_report.jsp">
                                    <button class="btn btn-primary">ADD ITEMS</button>
                                 </a><br>
                                 
                            <form action="just_locations_report_page.jsp" method="post">
