                   ...
                   <%
                    ...
                    <td>
                        ...
                        <br>
                            ...
                            <br>
                         <a onclick="return confirm('Are you sure?');" href="submit_single.jsp?id=<%=order_id%>&locations=<%=id%>&itemNumber=<%=item%>&name=<%=name%>&vTitle=<%=vTitle%>&price=<%=price%>&alt=<%=alt%>&pDesc=<%=pDesc%>&quantity=<%=quantity%>">
